...
public class CreatePluginMixin {
	...
	@WrapOperation(method = "lambda$registerClient$1", remap = false, at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/Entity;getEyePosition(F)Lnet/minecraft/world/phys/Vec3;", remap = true))
	...
	@WrapOperation(method = "lambda$registerClient$1", remap = false, at = @At(value = "INVOKE", target = "Lnet/minecraft/world/entity/Entity;getViewVector(F)Lnet/minecraft/world/phys/Vec3;", remap = true))
