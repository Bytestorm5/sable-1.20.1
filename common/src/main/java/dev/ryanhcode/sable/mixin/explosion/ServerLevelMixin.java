...
public abstract class ServerLevelMixin {
    ...
    /**
     * 1.20.1's {@code explode} has no particle or sound parameters
     */
    ...
    public Explosion sable$preExplode(final Entity entity,
        ...
        return original.call(entity, damageSource, explosionDamageCalculator, projectedPos.x, projectedPos.y, projectedPos.z, g, bl, explosionInteraction);
    }
}
