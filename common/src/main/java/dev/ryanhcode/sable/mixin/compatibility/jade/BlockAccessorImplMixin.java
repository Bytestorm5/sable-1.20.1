...
public class BlockAccessorImplMixin {
    ...
    @WrapOperation(method = "lambda$handleRequest$0", remap = false, at = @At(value = "INVOKE", target = "Lnet/minecraft/core/BlockPos;distSqr(Lnet/minecraft/core/Vec3i;)D", remap = true))
